...
EPOCHS=200 #1400 before, but we can start with 100 for testing and then scale up
LEARNING_RATE=1e-5
VAL_SPLIT=0.01
...
CKPT="/home/rg5218/scratch/SiT/results/024-SiT-L-2-Linear-velocity-None/checkpoints/0048700.pt"
